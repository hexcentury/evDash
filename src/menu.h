...
MENU_ITEM menuItemsSource[] = {
    ...
    {VEHICLE_TYPE_GEELY, MENU_VEHICLE_TYPE, MENU_NO_MENU, "Geely"},
    ...
    {VEHICLE_TYPE_GEELY_TOP, VEHICLE_TYPE_GEELY, MENU_TOP_LEVEL, "<- parent menu"},
    {VEHICLE_TYPE_GEELY_FY11, VEHICLE_TYPE_GEELY, MENU_NO_MENU, "Geely Tugella"},
    ...
    {MENU_ADAPTER_OBD2_BT3, MENU_ADAPTER_TYPE, MENU_NO_MENU, "OBD2 Bluetooth3 [DEV]"},
